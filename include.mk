...
$(info COMPONENTS_OBJ_PATH = ${COMPONENTS_OBJ_PATH})

OBJS += ${COMPONENTS_OBJ_PATH}
HDRS += ${COMPONENTS_INCLUDE_PATH}
...
PATH_TO_COMPONENTS_INCLUDE = $(shell dirname $(COMPONENTS_INCLUDE_PATH))
$(info PATH_TO_COMPONENTS_CODE = ${PATH_TO_COMPONENTS_CODE})

${COMPONENTS_CODE_PATH}: | ${PATH_TO_COMPONENTS_CODE}/
${COMPONENTS_INCLUDE_PATH}: | ${PATH_TO_COMPONENTS_INCLUDE}/

${COMPONENTS_CODE_PATH} ${COMPONENTS_INCLUDE_PATH}: ${COMPONENTS_DIR} ${COMPONENTS_COLLECTOR_PATH}
	@echo -e "${STYLE_CMD} - Creating components collection $<${STYLE_OFF}"
